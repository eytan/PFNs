...
dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-30_16-21-19__synthetic__trials_3__seed_0__uncorr_final/features_3__tasks_4__lengthscale_None__task_corr_0_8__uncorr_tasks_0__n_target_2__n_source_20__seed_0"
models = ["fallen-cherry-483", "wobbly-donkey-484", "youthful-wildflower-481"]
model_to_label = {
    "fallen-cherry-483": "MTPFN (p=0.0)",
    "wobbly-donkey-484": "MTPFN (p=0.1)",
    "youthful-wildflower-481": "MTPFN (p=0.2)",
    "mtgp": "ICM",
    "gp": "GP",
    "scaml": "ScaML",
}
title = "0 Unrelated Tasks"
plot_bo_ax(axs[0], dir, models, title)


dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-30_16-21-19__synthetic__trials_3__seed_0__uncorr_final/features_3__tasks_4__lengthscale_None__task_corr_0_8__uncorr_tasks_1__n_target_2__n_source_20__seed_0/function_4"
model_to_label = {
    "sparkling-microwave-480": "MTPFN (p=0.0)",
    "stilted-night-482": "MTPFN (p=0.1)",
    "youthful-wildflower-481": "MTPFN (p=0.2)",
    "mtgp": "ICM",
    "gp": "GP",
    "scaml": "ScaML",
}
models = ["sparkling-microwave-480", "stilted-night-482", "youthful-wildflower-481"]
title = "1 Unrelated Task"
plot_bo_function_ax(axs[1], dir, models, title)


dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-30_16-21-19__synthetic__trials_3__seed_0__uncorr_final/features_3__tasks_4__lengthscale_None__task_corr_0_8__uncorr_tasks_2__n_target_2__n_source_20__seed_0/"
model_to_label = {
    "sparkling-microwave-480": "MTPFN (p=0.0)",
    "wobbly-donkey-484": "MTPFN (p=0.1)",
    "youthful-wildflower-481": "MTPFN (p=0.2)",
...
models = ["sparkling-microwave-480", "wobbly-donkey-484", "youthful-wildflower-481"]
title = "2 Unrelated Tasks"
plot_bo_ax(axs[2], dir, models, title)


dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-30_16-21-19__synthetic__trials_3__seed_0__uncorr_final/features_3__tasks_4__lengthscale_None__task_corr_0_8__uncorr_tasks_3__n_target_2__n_source_20__seed_0/"
model_to_label = {
    "likely-donkey-479": "MTPFN (p=0.0)",
    "fallen-cherry-483": "MTPFN (p=0.1)",
    "stilted-night-482": "MTPFN (p=0.2)",
    "mtgp": "ICM",
    "gp": "GP",
    "scaml": "ScaML",
}
models = ["likely-donkey-479", "fallen-cherry-483", "stilted-night-482"]
...
# legend above plot
fig.legend(loc='upper center', bbox_to_anchor=(0.5, 1.1), ncol=6, handles=handles, labels=labels)
# plt.legend()
plt.tight_layout()
plt.savefig("uncorr.pdf", bbox_inches='tight')

# original
# # uncorr 0
# # dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-29_20-08-47__synthetic__trials_3__seed_0__uncorr/features_3__tasks_4__lengthscale_None__task_corr_None__uncorr_tasks_0__n_target_2__n_source_20__seed_0"
# dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-29_21-12-23__synthetic__trials_3__seed_0__uncorr/features_3__tasks_4__lengthscale_None__task_corr_None__uncorr_tasks_0__n_target_2__n_source_20__seed_0"
# models = ["fallen-cherry-483", "stilted-night-482", "youthful-wildflower-481"]
# model_to_label = {
#     "fallen-cherry-483": "MTPFN (p=0.0)",
#     "stilted-night-482": "PFN (p=0.1)",
#     "youthful-wildflower-481": "PFN (p=0.2)",
#     "mtgp": "ICM",
#     "gp": "GP",
#     "scaml": "ScaML",
#     # "random": "Random",
# }
# path = "uncorr_0.png"
# # title = "4 Total Tasks, 0/3 Auxiliary Uncorrelated\n10 Settings, 20 Trials Each"
# title = "0 Unrelated Tasks"
# plot_bo_ax(axs[0], dir, models, title, path)
# # plot_all(dir, models, title, path.replace(".png", "_all.png"))


# # uncorr 1
# # dir = "/home/yl9959/mtpfn/eval_plot/25-01-28_13-31-07__synthetic__trials_3__seed_0__uncorr_final/features_3__tasks_4__lengthscale_None__task_corr_0_8__uncorr_tasks_1__n_target_2__n_source_20__seed_0"
# dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-29_20-08-47__synthetic__trials_3__seed_0__uncorr/features_3__tasks_4__lengthscale_None__task_corr_None__uncorr_tasks_1__n_target_2__n_source_20__seed_0"
# models = ["sparkling-microwave-480", "youthful-wildflower-481", "wobbly-donkey-484"]
# model_to_label = {
#     "sparkling-microwave-480": "PFN (p=0.0)",
#     "youthful-wildflower-481": "PFN (p=0.1)",
#     "wobbly-donkey-484": "PFN (p=0.2)",
#     "mtgp": "ICM",
#     "gp": "GP",
#     "scaml": "ScaML",
#     # "random": "Random",
# }
# path = "uncorr_1.png"
# title = "4 Total Tasks, 1/3 Auxiliary Uncorrelated\n10 Settings, 20 Trials Each"
# title = "1 Unrelated Task"
# plot_bo_ax(axs[1], dir, models, title, path)
# # plot_all(dir, models, title, path.replace(".png", "_all.png"))

# dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-29_20-08-47__synthetic__trials_3__seed_0__uncorr/features_3__tasks_4__lengthscale_None__task_corr_None__uncorr_tasks_2__n_target_2__n_source_20__seed_0"
# path = "uncorr_2.png"
# title = "4 Total Tasks, 2/3 Auxiliary Uncorrelated\n10 Settings, 20 Trials Each"
# models = ["stilted-night-482",  "wobbly-donkey-484", "youthful-wildflower-481"]
# # models = ["youthful-wildflower-481"]
# model_to_label = {
#     "stilted-night-482": "PFN (p=0.0)",
#     "wobbly-donkey-484": "PFN (p=0.1)",
#     "youthful-wildflower-481": "PFN (p=0.2)",
#     "mtgp": "ICM",
#     "gp": "GP",
#     "scaml": "ScaML",
...
# }
# title = "2 Unrelated Tasks"
# plot_bo_ax(axs[2], dir, models, title, path)
# # plot_all(dir, models, title, path.replace(".png", "_all.png"))

# dir = "/home/lily_l/private_multitask_pfn/eval_plot/25-01-29_20-08-47__synthetic__trials_3__seed_0__uncorr/features_3__tasks_4__lengthscale_None__task_corr_None__uncorr_tasks_3__n_target_2__n_source_20__seed_0"
# path = "uncorr_3.png"
# models = ["fallen-cherry-483", "youthful-wildflower-481", "stilted-night-482"]
# model_to_label = {
#     "fallen-cherry-483": "PFN (p=0.0)",
#     # "wobbly-donkey-484": "PFN (p=0.2)",
#     "youthful-wildflower-481": "PFN (p=0.1)",
#     "stilted-night-482": "PFN (p=0.2)",
#     "mtgp": "GP",
#     "gp": "ICM",
#     "scaml": "ScaML",
#     # "random": "Random",
# }
# title = "4 Total Tasks, 3/3 Auxiliary Uncorrelated\n10 Settings, 20 Trials Each"
# title = "3 Unrelated Tasks"
# plot_bo_ax(axs[3], dir, models, title, path)
# # plot_all(dir, models, title, path.replace(".png", "_all.png"))

# plt.legend()
# plt.tight_layout()
# plt.savefig("uncorr.pdf")